...
module.exports.postLoginData = (request, response) => {

    //Create user
    user= {
        id: 1,
        username: 'manuel',
        email: 'mjtr1995@gmail.com'
    };
...
module.exports.getTokenInitialData = (request, response) => {
...
module.exports.getTokenAllData = (request, response) => {

    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token getTokenAllData");
            response.sendStatus(403);
        }
        else {
...
module.exports.getTokenSingleDataNameYear = (request, response) => {


    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token getTokenSingleDataNameYear");
            response.sendStatus(403);
        }
        else {
...
module.exports.getTokenData = (request, response) => {
    ...
    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token getTokenData");
            response.sendStatus(403);
        }
        else {
...
module.exports.postTokenDenied = (request, response) => {

    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token post Token Denied");
            response.sendStatus(403);
        }
        else {
...
module.exports.postTokenDataGroup = (request, response) => {

    jwt.verify(request.token, 'secretkey', (err, authData) => {

        if (err) {
            console.log("bad token post Token Data Group");
            response.sendStatus(403);
        }
        else {
...
module.exports.putTokenDenied = (request, response) => {


    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token put Token Denied");
            response.sendStatus(403);
        }
        else {
...
module.exports.putTokenSingleData = (request, response) => {


    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token put Token Single Data");
            response.sendStatus(403);
        }
        else {
...
module.exports.deleteTokenData = (request, response) => {

    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token delete token data");
            response.sendStatus(403);
        }
        else {
...
module.exports.deleteTokenAll = (request, response) => {


    jwt.verify(request.token, 'secretkey', (err, authData) => {
        if (err) {
            console.log("bad token delete token all ");
            response.sendStatus(403);
        }
        else {
